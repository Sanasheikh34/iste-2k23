      ...
      <div className="events-container" >
        <div className="row">
          ...
          <div className="col-lg-4 txt text-1 content">
            <h1>Hult Prize</h1>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aliquam consectetur distinctio placeat, ex, error aut ea explicabo earum laudantium rem at id nostrum! Sapiente alias quam veniam non magni error.</p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-4 txt text-2 content">
            <h1>Prodyogiki</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse non voluptatibus itaque illum, eum eius sequi iure similique quasi, rem temporibus ab magni fugit laborum odio facilis excepturi? Deserunt, repellendus!</p>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-4 txt text-3 content">
            <h1>Pahal</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad eaque maiores dignissimos nam iure aperiam, ratione molestias laboriosam neque iusto beatae eligendi eius vel eveniet autem dolore, perferendis, numquam veniam.</p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-4 txt text-4 content">
            <h1>Prarambh</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores incidunt ad quaerat. Veniam tempore possimus aut totam sunt corrupti suscipit magni blanditiis, quia necessitatibus iste fugiat facilis sed fuga voluptatum?</p>
          </div>
